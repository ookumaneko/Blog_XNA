...
namespace Menu
{
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        public Game1()
        {
            ...
            menu.AddMenuItem("Option", new Vector2(400.0f, 325.0f));
            menu.AddMenuItem("Extra", new Vector2(400.0f, 350.0f));
            menu.AddMenuItem("Credits", new Vector2(400.0f, 375.0f));
            menu.AddMenuItem("Exit", new Vector2(400.0f, 400.0f));
        }
